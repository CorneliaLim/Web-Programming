...
<head>
  ...
  <title>FC Complaint System</title>
...
<body>
  <div class="header">
    ...
    <h1>🛠️ Facilities Complaint</h1>
      <p><a href="register.php" class="task">Register</a></p>
      <p><a href="login.php" class="task">Login</a></p>
    </nav>
  </div>
    <br>
  ...
  <div class="main-content">
    ...
    <br>
    <button onclick="location.href='complaint.php'"><b>Complaint Here</b></button> <button onclick="location.href='viewComplaint.php'"><b>View Complaint History</b></button>
  </div>
    <br>
  <div class="footer">
